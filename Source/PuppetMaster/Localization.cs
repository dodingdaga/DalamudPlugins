    ...
    public static class Localization
    {
        ...
        private static void InitializeEnglish()
        {
            Strings[PluginLanguage.English] = new Dictionary<string, string>
            {
                ...
                ["Common.Tooltip.AllowAllCommands"] = "When enabled and a keyword is matched, the text after the keyword will be executed as a raw FFXIV command with a '/' prefix.\nExample: keyword 'test', message 'test ac Vercure <t>' will execute '/ac Vercure <t>'",
                ...
                ["Pokemon_Enable"] = "Enable Pokemon Mode",
                ["Pokemon_Enable_Tooltip"] = "Allow others to temporarily control your character using a password",
                ["Pokemon_Password"] = "Activation Password",
                ["Pokemon_Password_Tooltip"] = "Others can say this password in chat to activate Pokemon mode",
                ["Pokemon_Timeout"] = "Timeout (minutes)",
                ["Pokemon_Timeout_Tooltip"] = "0 = no timeout",
                ["Pokemon_CurrentStatus"] = "Current Status",
                ["Pokemon_Status_Active"] = "Active, Master: {0}",
                ["Pokemon_Status_Inactive"] = "Inactive",
                ["Pokemon_Status_Instructions"] = "Have someone say the password in chat to activate",
                ["Pokemon_Status_TimeRemaining"] = "Time remaining: {0}m {1}s",
                ["Pokemon_Status_Expired"] = "Expired",
                ["Pokemon_Deactivate"] = "Deactivate",
                ["Pokemon_Instructions_Title"] = "Instructions:",
                ["Pokemon_Instructions_Step1"] = "1. Set a hard-to-guess password",
                ["Pokemon_Instructions_Step2"] = "2. Have someone say the password in chat",
                ["Pokemon_Instructions_Step3"] = "3. All their messages will be executed as commands",
                ["Pokemon_Instructions_Warning"] = " Use only with people you fully trust",
                ["Pokemon_DisabledMessage"] = "Pokemon mode is disabled",
                ["UI_PokemonSettings"] = "Pokemon Mode Settings",
        ...
        private static void InitializeChinese()
        {
            Strings[PluginLanguage.Chinese] = new Dictionary<string, string>
            {
                ...
                ["Common.Tooltip.AllowAllCommands"] = "启用后，当关键词匹配成功时，关键词后的文本将直接加上'/'前缀作为FFXIV命令执行。\n示例：关键词'test'，消息'test ac Vercure <t>'将执行'/ac Vercure <t>'",
                ...
                ["Pokemon_Enable"] = "启用宝可梦模式",
                ["Pokemon_Enable_Tooltip"] = "允许他人使用密码临时控制你的角色",
                ["Pokemon_Password"] = "激活密码",
                ["Pokemon_Password_Tooltip"] = "他人在聊天中输入此密码即可激活宝可梦模式",
                ["Pokemon_Timeout"] = "超时时间（分钟）",
                ["Pokemon_Timeout_Tooltip"] = "0 = 永不超时",
                ["Pokemon_CurrentStatus"] = "当前状态",
                ["Pokemon_Status_Active"] = "已激活，控制者：{0}",
                ["Pokemon_Status_Inactive"] = "未激活",
                ["Pokemon_Status_Instructions"] = "让他人在聊天中输入密码来激活",
                ["Pokemon_Status_TimeRemaining"] = "剩余时间：{0}分{1}秒",
                ["Pokemon_Status_Expired"] = "已超时",
                ["Pokemon_Deactivate"] = "手动关闭",
                ["Pokemon_Instructions_Title"] = "使用说明：",
                ["Pokemon_Instructions_Step1"] = "1. 设置一个不易猜到的密码",
                ["Pokemon_Instructions_Step2"] = "2. 让他人在聊天中输入这个密码",
                ["Pokemon_Instructions_Step3"] = "3. 该玩家的所有发言将被尝试作为命令执行",
                ["Pokemon_Instructions_Warning"] = "请仅对完全信任的人使用此功能",
                ["Pokemon_DisabledMessage"] = "宝可梦模式已禁用",
                ["UI_PokemonSettings"] = "宝可梦模式设置",
